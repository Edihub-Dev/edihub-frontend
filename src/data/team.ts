...
export const team = [
  {
    ...
    achievements: [
      "Led digital strategy for 50+ Fortune 500 companies",
      "Pioneered AI-integrated design workflows",
      "Featured in Forbes 30 Under 30 (2018)"
    ],
    social: {
      linkedin: "#",
      twitter: "#"
  ...
  },
  {
    ...
    achievements: [
      "Architected backend for massive e-commerce platforms",
      "AWS Certified Solutions Architect",
      "Regular speaker at JSConf"
    ],
    social: {
      linkedin: "#",
      github: "#"
  ...
  },
  {
    ...
    achievements: [
      ...
      "Brand consultant for global fashion houses",
      "Published illustrator and visual artist"
    ],
    social: {
      dribbble: "#",
      behance: "#"
  ...
  },
  {
    ...
    achievements: [
      "Managed $5M+ project portfolios",
      "PMP Certified Professional",
      "Specialist in remote team optimization"
    ],
    social: {
      linkedin: "#"
    }
  },
  {
    ...
    achievements: [
      "Developed high-security fintech APIs",
      "Expert in data encryption and privacy",
      "Open source contributor to Node.js ecosystem"
    ],
    social: {
      github: "#",
      twitter: "#"
  ...
  },
  {
    ...
    achievements: [
      "Conducted 1000+ hours of user testing",
      "PhD in Cognitive Psychology",
      "Pioneer in accessibility-first design research"
    ],
    social: {
      linkedin: "#",
      twitter: "#"
  ...
  },
  {
    ...
    achievements: [
      "Creator of award-winning marketing sites",
      "Awwwards Jury Member",
      "Expert in CSS animation and micro-interactions"
    ],
    social: {
      behance: "#",
      instagram: "#"
  ...
  },
  {
    ...
    achievements: [
      "Core developer for open source UI kits",
      "Specialist in serverless architecture",
      "Marathon runner and coding mentor"
    ],
    social: {
      github: "#",
      linkedin: "#"
